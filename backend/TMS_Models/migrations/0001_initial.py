# Generated by Django 3.2.9 on 2022-05-19 17:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AccountTypeId', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_type', to='TMS_Models.accountstype')),
            ],
        ),
        migrations.CreateModel(
            name='UserAuth',
            fields=[
                ...
                ('UserId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_auth', to='TMS_Models.users')),
            ],
        ),
        migrations.CreateModel(
            name='State',
