	...
	AmsifySuggestags.prototype = {
		...
		*/
		...
		createHTML : function() {
			...
			var sTagsInput            = '<input type="text" style="border:none !important; box-shadow:none !important;" class="'+this.classes.sTagsInput.substring(1)+'" placeholder="'+this.defaultLabel+'">';
